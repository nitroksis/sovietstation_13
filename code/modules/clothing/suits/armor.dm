...
/obj/item/clothing/suit/armor/hosbluejacket
	name = "Blue Jacket"
	desc = "A blue jacket, that belongs to HoS. Looks fancy."
	icon_state = "hosbluejacket"
	item_state = "armor"
	flags = FPRINT | TABLEPASS | ONESIZEFITSALL
	armor = list(melee = 50, bullet = 15, laser = 50, energy = 10, bomb = 25, bio = 0, rad = 0)

/obj/item/clothing/suit/armor/wardenbluejacket
	name = "Blue Jacket"
	desc = "A blue jacket, that belongs to Warden. Looks fancy."
	icon_state = "wardenbluejacket"
	item_state = "armor"
	flags = FPRINT | TABLEPASS | ONESIZEFITSALL
	armor = list(melee = 50, bullet = 15, laser = 50, energy = 10, bomb = 25, bio = 0, rad = 0)

/obj/item/clothing/suit/armor/wardendnavyjacket
	name = "Navy Jacket"
	desc = "A blue jacket, that belongs to Warden. Looks fancy."
	icon_state = "hosbluejacket"
	item_state = "armor"
...
/obj/item/clothing/suit/armor/officertanjacket
	name = "Tan Jacket"
	desc = "A tan jacket, that belongs to Security. Looks fancy."
	icon_state = "hosbluejacket"
	item_state = "armor"
	flags = FPRINT | TABLEPASS | ONESIZEFITSALL
	armor = list(melee = 50, bullet = 15, laser = 50, energy = 10, bomb = 25, bio = 0, rad = 0)

/obj/item/clothing/suit/armor/hosdnavyjacket
	name = "Navy Jacket"
	desc = "A navy jacket, that belongs to HoS. Looks fancy."
	icon_state = "hosdnavyjacket"
	item_state = "armor"
	flags = FPRINT | TABLEPASS | ONESIZEFITSALL
	armor = list(melee = 50, bullet = 15, laser = 50, energy = 10, bomb = 25, bio = 0, rad = 0)

/obj/item/clothing/suit/armor/hostanjacket
	name = "Tan Jacket"
	desc = "A tan jacket, that belongs to HoS. Looks fancy."
	icon_state = "hostanjacket"
	item_state = "armor"
	flags = FPRINT | TABLEPASS | ONESIZEFITSALL
	armor = list(melee = 50, bullet = 15, laser = 50, energy = 10, bomb = 25, bio = 0, rad = 0)

/obj/item/clothing/suit/armor/officebluejacket
	name = "Blue Jacket"
	desc = "A blue jacket, that belongs to Security. Looks fancy."
	icon_state = "officebluejacket"
	item_state = "armor"
	flags = FPRINT | TABLEPASS | ONESIZEFITSALL
	armor = list(melee = 50, bullet = 15, laser = 50, energy = 10, bomb = 25, bio = 0, rad = 0)

/obj/item/clothing/suit/armor/officerdnavyjacket
	name = "Blue Jacket"
	desc = "A blue jacket, that belongs to Security. Looks fancy."
...
/obj/item/clothing/suit/armor/wardentanjacket
	name = "Tan Jacket"
	desc = "A tan jacket, that belongs to Warden. Looks fancy."
